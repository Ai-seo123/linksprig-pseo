<?php
/**
 * Plugin Name: LinkSprig pSEO Helper
 * Description: Automates registration of Custom Post Types, ACF Fields, and Authentication filters for the LinkSprig pSEO Pipeline.
 * Version: 1.0.0
 ...
 */
function linksprig_register_cpts() {
    $cpts = array(
        'compare' => array(
            'singular'  => 'Comparison',
            'plural'    => 'Comparisons',
...
add_action( 'init', 'linksprig_register_cpts' );

/**
 * 2. Register ACF Local Field Groups
 */
function linksprig_register_acf_fields() {
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array( 'key' => 'field_linksprig_solution', 'label' => 'LinkSprig Solution', 'name' => 'LinkSprig_solution', 'type' => 'textarea' ),
        ),
...
add_action( 'acf/init', 'linksprig_register_acf_fields' );
